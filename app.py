...
def clean_reply(text):
    ...
    # Βάζει κενά μετά από σημεία στίξης
    text = re.sub(r"([,.!?;:])(?=\S)", r"\1 ", text)

    # Βάζει κενό ανάμεσα σε ελληνικά και αγγλικά
    text = re.sub(r"([α-ωΑ-ΩάέήίόύώΆΈΉΊΌΎΏϊΐϋΰ])([A-Za-z])", r"\1 \2", text)
    text = re.sub(r"([A-Za-z])([α-ωΑ-ΩάέήίόύώΆΈΉΊΌΎΏϊΐϋΰ])", r"\1 \2", text)

    # Διορθώσεις συχνών κολλημένων λέξεων
    fixes = {
        "Είμαιο": "Είμαι ο ",
        "Είμαιεδώ": "Είμαι εδώ",
        "μπορώνα": "μπορώ να",
        "σαςβοηθήσω": "σας βοηθήσω",
        "σεβοηθήσω": "σε βοηθήσω",
        "Πείτεμου": "Πείτε μου",
        "πείτεμου": "πείτε μου",
        "χρειάζεστεβοήθεια": "χρειάζεστε βοήθεια",
        "χρειάζεσαιβοήθεια": "χρειάζεσαι βοήθεια",
        "Ωςcoding": "Ως coding",
        "Ως Coding": "Ως Coding",
        "premiumAIassistant": "premium AI assistant",
        "KyriazidhsAI": "Kyriazidhs AI",
        "Κυριαζίδης.Είμαι": "Κυριαζίδης. Είμαι",
        "χρήστη.Αν": "χρήστη. Αν",
        "βοηθήσωμε": "βοηθήσω με",
        "ιδέες,προγραμματισμό": "ιδέες, προγραμματισμό",
        "σχολείο,καριέρα": "σχολείο, καριέρα",
        "καιό,τι": "και ό,τι",
        "θέλεις.": "θέλεις.",
        "προγραμματισμού": "προγραμματισμού",
        "Απαντήσειςσε": "Απαντήσεις σε",
        "ερωτήσειςγια": "ερωτήσεις για",
        "Βοήθειαστην": "Βοήθεια στην",
        "κατανόησηεννοιών": "κατανόηση εννοιών",
        "Παραδείγματακώδικα": "Παραδείγματα κώδικα",
        "καιεξηγήσεις": "και εξηγήσεις",
        "Συμβουλέςγια": "Συμβουλές για",
        "τηνκαλύτερη": "την καλύτερη",
        "πρακτικήκαι": "πρακτική και",
        "οργάνωσητου": "οργάνωση του",
        "κώδικα": "κώδικα",
        "Καιπολλά": "Και πολλά",
        "άλλα!": "άλλα!"
    }
    ...
    # Καθαρίζει πολλά κενά
    text = re.sub(r"[ ]{2,}", " ", text)

    # Καθαρίζει πολλά κενά ανά γραμμή
